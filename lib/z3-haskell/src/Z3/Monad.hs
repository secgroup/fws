...
liftFun0 :: MonadZ3 z3 => (Base.Context -> IO b) -> z3 b
liftFun0 f = getContext >>= \ctx -> liftIO (f ctx)
...
liftSolver0 :: MonadZ3 z3 =>
       (Base.Context -> Base.Solver -> IO b) -> Solver
    -> z3 b
liftSolver0 f_s s =
  do ctx <- getContext
     liftIO . f_s ctx $ s
...
liftSolver1 :: MonadZ3 z3 =>
       (Base.Context -> Base.Solver -> a -> IO b) -> Solver
    -> a -> z3 b
liftSolver1 f_s slvr a =
  do ctx <- getContext
     liftIO . (\s -> f_s ctx s a) $ slvr

liftSolver2 :: MonadZ3 z3 => (Base.Context -> Base.Solver -> a -> b -> IO c) -> Solver
                             -> a -> b -> z3 c
liftSolver2 f s a b = do
  ctx <- getContext
  liftIO $ f ctx s a b
...
newEnvWith :: (Base.Config -> IO Base.Context) -> Opts -> IO Z3Env
newEnvWith mkContext opts =
...
mkParams = liftFun0 Base.mkParams
...
mkBoolSort = liftFun0 Base.mkBoolSort
...
mkIntSort = liftFun0 Base.mkIntSort
...
mkRealSort = liftFun0 Base.mkRealSort
...
interpolationProfile = liftFun0 Base.interpolationProfile
...
mkSolver :: MonadZ3 z3 => z3 Solver
mkSolver = liftFun0 Base.mkSolver

mkSolverForLogic :: MonadZ3 z3 => Logic -> z3 Solver
mkSolverForLogic = liftFun1 Base.mkSolverForLogic

mkSimpleSolver :: MonadZ3 z3 => z3 Solver
mkSimpleSolver = liftFun0 Base.mkSimpleSolver

-- | Return a string describing all solver available parameters.
solverGetHelp :: MonadZ3 z3 => Solver -> z3 String
solverGetHelp = liftSolver0 Base.solverGetHelp

-- | Set the solver using the given parameters.
solverSetParams :: MonadZ3 z3 => Solver -> Params -> z3 ()
solverSetParams = liftSolver1 Base.solverSetParams

-- | Create a backtracking point.
solverPush :: MonadZ3 z3 => Solver -> z3 ()
solverPush = liftSolver0 Base.solverPush

-- | Backtrack /n/ backtracking points.
solverPop :: MonadZ3 z3 => Solver -> Int -> z3 ()
solverPop = liftSolver1 Base.solverPop

solverReset :: MonadZ3 z3 => Solver -> z3 ()
solverReset = liftSolver0 Base.solverReset

-- | Number of backtracking points.
solverGetNumScopes :: MonadZ3 z3 => Solver -> z3 Int
...
solverAssertCnstr :: MonadZ3 z3 => Solver -> AST -> z3 ()
...
solverAssertAndTrack :: MonadZ3 z3 => Solver -> AST -> AST -> z3 ()
solverAssertAndTrack = liftSolver2 Base.solverAssertAndTrack

-- | Check whether the assertions in a given solver are consistent or not.
solverCheck :: MonadZ3 z3 => Solver -> z3 Result
solverCheck = liftSolver0 Base.solverCheck

-- | Check whether the assertions in the given solver and optional assumptions are consistent or not.
solverCheckAssumptions :: MonadZ3 z3 => Solver -> [AST] -> z3 Result
...
solverGetModel :: MonadZ3 z3 => Solver -> z3 Model
...
solverGetUnsatCore :: MonadZ3 z3 => Solver -> z3 [AST]
...
solverAssert :: MonadZ3 z3 => Solver -> AST -> z3 ()
solverAssert = solverAssertCnstr

solverCheckAndGetModel :: MonadZ3 z3 => Solver -> z3 (Result, Maybe Model)
...
solverLocal :: MonadZ3 z3 => Solver -> z3 a -> z3 a
solverLocal s q = do
  solverPush s
  r <- q
  solverPop s 1
...
withModel :: (Applicative z3, MonadZ3 z3) =>
               Solver -> (Base.Model -> z3 a) -> z3 (Result, Maybe a)
withModel s f = do
 (r,mb_m) <- solverCheckAndGetModel s
